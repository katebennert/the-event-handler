    ...
    {user.role === 'Client' ? 
        <div className="client-nav">
            ...
            <div className="left-section">
                ...
                <li><NavLink to={`/users/${user.id}`} className="nav-link">Edit My Profile </NavLink><nobr className="notification-dot" >{user.name ? "" : "🔴"}</nobr></li>
        ...
        <div className="planner-nav">
            ...
            <div className="left-section">
                ...
                <li><NavLink to={`/`} className="nav-link">Edit My Planner Profile </NavLink><nobr className="notification-dot" >{user.name ? "" : "🔴"}</nobr></li>
